...
// 하나 이상을 지정하면 그때부터 데이터는 오브젝트( object ) 가 됩니다.
...
// 2. 객체의 속성과 메서드
    ...
    object.useMethod(); // 함수의 실행은 괄호를 붙여서
    // object.useMethod; 오류는 나지 않지만 아무 일도 일어나지 않음.
...
// 객체 생성이후 동적으로 속성 (멤버변수) 를 추가 할 수 있습니다.
student.이름 = '홍길동';
student.취미 = '악기';
student.특기 = '프로그래밍';
...
var obj1 = new Student('홍길동', 85, 90, 85, 100);
console.log('   이름    총점    평균');
console.log( obj1.toString() );

// 7. 프로토 타입
// - 생성자 함수를 사용해 생성된 객체가 공동으로 가지는 공간.
// - 자바스크립트의 모든 함수는 변수 prototype을 갖습니다.
// - 그리고 prototype은 객체 입니다.
...
// 모든 함수에 존재하는 프로토 타입은 특히나 객체의 생성자로 사용할때 그 용도가 확실해집니다.
...
// 아래처럼 객체를 생성후에 멤버메서드를 추가하느냐, 위에 처럼 메서드 추가 후 객체를 만드느냐
// std1 = new Student('홍길동', 88, 99, 77, 66);
